...
// Dummy product data with ratings, reviews and stock status
const products = [
  {
    id: 1,
    ...
    description: "A sleek modern ceramic vase that complements any interior style.",
    rating: 4.7,
    inStock: true,
    reviews: [
      {
        ...
        user: "Emma W.",
        rating: 5,
        comment: "Absolutely beautiful! Perfect size for my dining table.",
        date: "2023-06-15"
      },
      {
        id: 2,
        user: "David K.",
        rating: 4,
        comment: "Great quality, but the color is slightly off from the picture.",
        date: "2023-05-22"
      }
    ]
  },
  {
    ...
    description: "Handwoven rattan baskets perfect for storage or decoration.",
    rating: 4.8,
    inStock: true,
    reviews: [
      {
        ...
        user: "Sophia L.",
        rating: 5,
        comment: "Love these baskets! They're both functional and beautiful.",
        date: "2023-07-10"
      }
    ]
  },
  {
    ...
    sizes: ["150x200cm", "200x240cm"],
    colors: ["Beige", "Gray", "White"],
    material: "100% Linen",
    description: "Soft and cozy linen throw blanket for your sofa or bed.",
    rating: 4.5,
    inStock: true,
    reviews: [
      {
        ...
        user: "Michael B.",
        rating: 5,
        comment: "Incredibly soft and perfect weight for all seasons.",
        date: "2023-06-30"
      },
      {
        id: 2,
        user: "Olivia R.",
        rating: 4,
        comment: "Beautiful but wrinkles easily as expected with linen.",
        date: "2023-05-15"
      }
    ]
  },
  {
    id: 4,
    name: "Geometric Wall Art - Black & Gold",
    price: 12500,
    images: [
      "/src/assets/images/Collection/Cart.jpg",
      "/src/assets/images/Collection/Cart.jpg",
    ...
    sizes: ["60x80cm", "80x120cm"],
    colors: ["Black & Gold", "White & Gold"],
    material: "Metal Frame, Canvas Print",
    description: "Stunning geometric wall art to elevate your space.",
    rating: 4.9,
    inStock: false,
    reviews: []
  },
  {
    ...
    description: "Elegant marble coasters to protect your surfaces in style.",
    rating: 4.3,
    inStock: true,
    reviews: [
      {
        ...
        user: "James P.",
        rating: 4,
        comment: "Beautiful but need to be careful as marble can chip.",
        date: "2023-06-05"
      }
    ]
  },
  {
    ...
    description: "Minimalist wooden side table with clean lines.",
    rating: 4.6,
    inStock: true,
    reviews: [
      {
        ...
        user: "Robert H.",
        rating: 5,
        comment: "Sturdy and exactly as pictured. Easy to assemble.",
        date: "2023-05-20"
      },
      {
        id: 2,
...
const allSizes = ["Small", "Medium", "Large", "Set of 3", "150x200cm", "200x240cm", "60x80cm", "80x120cm", "Set of 6", "45x45x50cm"];
...
function HomeDec() {
  ...
  const [activeTab, setActiveTab] = useState("description"); // For product details tabs
  ...
  const submitReview = () => {
    ...
    // Update the products array (in a real app, this would be an API call)
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/20 flex items-end pb-12 md:pb-20 justify-center">
          <div className="text-center px-4">
            ...
            <p className="text-white/90 text-lg md:text-xl max-w-2xl">
              Elevate your living space with our premium home decor items
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mb-10">
          ...
          <div className={`${showFilters ? 'block' : 'hidden'} md:block`}>
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              ...
              {/* Active Filters */}
              {(selectedSizes.length > 0 || search || priceRange[0] > 0 || priceRange[1] < 20000) && (
                <div className="mt-6">
