...
const products = [
  {
    ...
    price: 4500,
    images: [
      "/src/assets/images/Shop_Men/Men 1.jpg",
      "/src/assets/images/Shop_Men/Men 5.jpg",
      "/src/assets/images/Shop_Men/Men 2.jpg",
    ],
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black", "Navy", "Gray"],
    material: "100% Cotton",
    description: "A premium cotton hoodie, perfect for everyday comfort and style.",
    rating: 4.5,
    inStock: true,
    reviews: [
      {
      ...
      },
      {
        ...
        user: "Sarah M.",
        rating: 4,
        comment: "Great hoodie, but the color is slightly darker than shown.",
        date: "2023-04-22"
      }
    ]
  },
  {
    ...
    description: "Classic crewneck sweatshirt for a timeless look.",
    rating: 4.2,
    inStock: false,
    reviews: [
      {
        ...
        user: "Michael T.",
        rating: 4,
        comment: "Good quality for the price. Fits as expected.",
        date: "2023-06-10"
      }
    ]
  },
  {
    ...
    price: 3800,
    images: [
      "/src/assets/images/Shop_Men/Men 3.jpg",
      "/src/assets/images/Shop_Men/Men 5.jpg",
      "/src/assets/images/Shop_Men/Men 2.jpg",
    ],
    sizes: ["S", "M", "L", "XL"],
    ...
    reviews: [
      {
        ...
        user: "David L.",
        rating: 5,
        comment: "Very comfortable and perfect for workouts. Highly recommend!",
        date: "2023-05-30"
      },
      {
        id: 2,
        user: "Emma S.",
        rating: 4,
        comment: "Great joggers, but the waist could be a bit more elastic.",
        date: "2023-04-15"
      }
    ]
  },
  {
    ...
    description: "Slim fit jeans with stretch for all-day comfort.",
    rating: 4.0,
    inStock: true,
    reviews: []
  },
  {
    ...
    price: 2800,
    images: [
      "/src/assets/images/Shop_Men/Men 6.jpg",
      "/src/assets/images/Shop_Men/Men 5.jpg",
      "/src/assets/images/Shop_Men/Men 2.jpg",
    ],
    sizes: ["S", "M", "L", "XL"],
    ...
    description: "Oversized fit t-shirt for a relaxed look.",
    rating: 3.8,
    inStock: false,
    reviews: [
      {
        ...
        user: "Lisa K.",
        rating: 4,
        comment: "Nice fabric but runs a bit large even for oversized.",
        date: "2023-06-05"
      }
    ]
  },
  {
    ...
    price: 4900,
    images: [
      "/src/assets/images/Shop_Men/Men 7.jpg",
      "/src/assets/images/Shop_Men/Men 5.jpg",
      "/src/assets/images/Shop_Men/Men 2.jpg",
    ],
    sizes: ["S", "M", "L", "XL"],
    ...
    reviews: [
      {
        ...
        user: "Robert P.",
        rating: 5,
        comment: "Perfect for outdoor activities. Lots of pockets!",
        date: "2023-05-20"
      },
      {
        id: 2,
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/20 flex items-end pb-12 md:pb-20 justify-center">
          <div className="text-center px-4">
            ...
            <p className="text-white/90 text-lg md:text-xl max-w-2xl">
              Discover premium quality clothing designed for comfort and style
            </p>
          </div>
        </div>
      </div>
