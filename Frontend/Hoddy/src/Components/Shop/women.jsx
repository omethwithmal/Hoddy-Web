...
// Dummy product data for women's collection with ratings, reviews and stock status
const products = [
  {
    id: 1,
    name: "Elegant Wrap Dress - Floral",
    price: 5500,
    images: [
    ...
    description: "Flattering wrap dress with a feminine floral print, perfect for any occasion.",
    rating: 4.7,
    inStock: true,
    reviews: [
      {
        ...
        user: "Emma W.",
        rating: 5,
        comment: "Absolutely love this dress! Fits perfectly and very comfortable.",
        date: "2023-06-15"
      },
      {
        id: 2,
        user: "Sophia L.",
        rating: 4,
        comment: "Beautiful dress, just wish the fabric was a bit thicker.",
        date: "2023-05-22"
      }
    ]
  },
  {
    id: 2,
    name: "High-Waisted Jeans - Light Blue",
    price: 4800,
    images: [
      "/src/assets/images/Shop_Women/women 9.jpg",
    ...
    reviews: [
      {
        ...
        user: "Olivia P.",
        rating: 5,
        comment: "Perfect fit and so comfortable! My new favorite jeans.",
        date: "2023-07-10"
      }
    ]
  },
  {
    ...
    material: "100% Silk",
    description: "Luxurious silk blouse with a delicate drape for an elegant look.",
    rating: 4.5,
    inStock: true,
    reviews: [
      {
        ...
        user: "Ava S.",
        rating: 5,
        comment: "The quality is amazing! Feels so luxurious.",
        date: "2023-06-30"
      },
      {
        id: 2,
        user: "Mia K.",
        rating: 4,
        comment: "Beautiful blouse but requires careful washing.",
        date: "2023-05-15"
      }
    ]
  },
  {
    id: 4,
    name: "Knit Cardigan - Beige",
    price: 3800,
    images: [
      "/src/assets/images/Shop_Women/women 7.jpg",
      "/src/assets/images/Shop_Women/women 6.jpg",
      "/src/assets/images/Shop_Women/women 9.jpg",
    ],
    sizes: ["XS", "S", "M", "L", "XL"],
    ...
    description: "Cozy knit cardigan perfect for layering in any season.",
    rating: 4.1,
    inStock: false,
    reviews: []
  },
  {
    ...
    description: "Elegant pleated midi skirt with a flowing silhouette.",
    rating: 4.4,
    inStock: true,
    reviews: [
      {
        ...
        user: "Isabella R.",
        rating: 5,
        comment: "Love how this skirt moves! Perfect length.",
        date: "2023-06-05"
      }
    ]
  },
  {
    ...
    material: "100% Linen",
    description: "Breathable linen jumpsuit with a relaxed fit and adjustable waist tie.",
    rating: 4.6,
    inStock: true,
    reviews: [
      {
        ...
        user: "Charlotte M.",
        rating: 5,
        comment: "So comfortable and stylish! Gets lots of compliments.",
        date: "2023-05-20"
      },
      {
        id: 2,
        user: "Amelia T.",
        rating: 4,
        comment: "Love it but wrinkles easily as expected with linen.",
        date: "2023-04-10"
      }
    ]
  },
...
const allSizes = ["XS", "S", "M", "L", "XL", "24", "26", "28", "30", "32"];
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/20 flex items-end pb-12 md:pb-20 justify-center">
          <div className="text-center px-4">
            ...
            <p className="text-white/90 text-lg md:text-xl max-w-2xl">
              Discover elegant and comfortable clothing designed for the modern woman
            </p>
          </div>
        </div>
      </div>
